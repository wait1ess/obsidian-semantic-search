...
<style>
    ...
    .stTextInput > div > div > input:focus { border-color: #58a6ff !important; box-shadow: 0 0 0 3px rgba(88, 166, 255, 0.3) !important; }
    ...
    .sync-title { color: #f0f6fc; font-weight: 600; margin-bottom: 0.75rem; }
    .sync-info { color: #8b949e; font-size: 0.85rem; margin: 0.5rem 0; }
    
    .stats-bar { background-color: #161b22; border: 1px solid #21262d; border-radius: 6px; padding: 0.75rem 1rem; margin: 0.5rem 0; }
    ...
    .full-path { color: #6e7681; font-size: 0.85rem; margin-top: 0.35rem; font-family: monospace; }
    ...
    .md-content h1, .md-content h2, .md-content h3 { color: #f0f6fc; font-weight: 600; }
    .md-content table { width: 100%; border-collapse: collapse; margin: 0.75rem 0; }
    .md-content th { background-color: #21262d; color: #f0f6fc; padding: 0.6rem 0.8rem; border: 1px solid #30363d; }
    .md-content td { padding: 0.6rem 0.8rem; border: 1px solid #30363d; }
    .md-content code { background-color: #343942; padding: 0.2rem 0.45rem; border-radius: 6px; font-size: 0.88em; }
    .md-content pre { background-color: #161b22; border: 1px solid #21262d; border-radius: 6px; padding: 1rem; overflow-x: auto; }
    .md-content pre code { background: none; padding: 0; }
    .md-content blockquote { border-left: 4px solid #3b82f6; padding: 0.5rem 1rem; color: #8b949e; }
</style>
...
if query:
    ...
    if "error" in result:
        ...
        st.markdown(f'<div class="stats-bar">📊 {result["total"]} 个结果 | ⏱️ {result["took_ms"]}ms</div>', unsafe_allow_html=True)
            ...
            <div class="result-card">
                <div style="display: flex; justify-content: space-between; align-items: center;">
                    ...
                    <a href="{obsidian_url}" target="_blank" style="text-decoration: none;">
                        <button style="background-color: #238636; color: white; border: none; padding: 0.4rem 0.85rem; border-radius: 6px; cursor: pointer;">打开笔记</button>
                    </a>
                </div>
                <div class="path-area">
